<%@ Page Title="" Language="C#" MasterPageFile="~/home/Index.Master" AutoEventWireup="true" CodeFile="viewOrderDetails.aspx.cs" Inherits="Online_Food_Order_System.home.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card" style="margin-top:4%">
               <div class="card-body" style="font-size:20px">
                  ...
                  <div class="col-md-6">
                      ...
                      <br />
                   <center>
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="193px" Width="641px" DataSourceID="SqlDataSource1">
    ...
    <br />
            ...
            <a href="viewOrder.aspx"><< Back to Home</a><br><br>
                <br />
                               <br />
                               <br />
         </div>
